...
@section('content')
    ...
    <section class="bg-[#2A1B60] text-white pt-12 pb-24 md:py-20 overflow-hidden relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div class="w-full md:w-1/2 space-y-6">
                ...
                <div class="flex items-center gap-4 flex-wrap pt-2">
                    <x-ui.button 
                        ...
                        class="bg-[#FDE047] hover:bg-[#FACC15] text-[#1F2937] px-6 py-3 rounded-xl text-xs font-semibold shadow-md transition-all duration-200"
                    >
                        Rekomendasi
                    </x-ui.button>
            ...
            <!-- Right Side Image Carousel Mockup -->
            <div class="w-full md:w-1/2 flex items-center justify-center relative">
                <!-- Outer Carousel Frame with Arrow navigation styling from screenshot -->
                <div class="relative w-full max-w-sm group">
                    <!-- Left Arrow button mockup -->
                    <button class="absolute -left-5 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 border border-white/20 w-10 h-10 rounded-full flex items-center justify-center text-white transition-all cursor-pointer z-10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
                        </svg>
                    </button>
                    
                    <!-- Main image container with custom thick colorful borders -->
                    <div class="aspect-[3/4] w-full rounded-[2rem] overflow-hidden bg-[#221550] p-1 border-2 border-white/10 shadow-2xl relative">
                        <div class="w-full h-full rounded-[1.8rem] overflow-hidden relative">
                            <!-- Gradient mesh border overlay -->
                            <div class="absolute inset-0 bg-gradient-to-tr from-[#6366F1]/40 via-transparent to-[#FBCFE8]/20 z-10 pointer-events-none"></div>
                            <img src="https://images.unsplash.com/photo-1612872087720-bb876e2e67d1?q=80&w=600&auto=format&fit=crop" 
                                 alt="Volleyball Ekstrakurikuler" 
                                 class="w-full h-full object-cover">
                        </div>
                    </div>

                    <!-- Right Arrow button mockup -->
                    <button class="absolute -right-5 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 border border-white/20 w-10 h-10 rounded-full flex items-center justify-center text-white transition-all cursor-pointer z-10">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="text-center mb-12">
            <h2 class="text-2xl md:text-3xl font-semibold text-[#2A1B60] tracking-wide inline-block relative pb-3">
                ...
                <div class="absolute bottom-0 left-1/2 -translate-x-1/2 h-1 w-28 bg-[#2A1B60]/20 rounded-full"></div>
            </h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <x-ui.benefit-card 
                ...
                description="Dapat mengembangkan kedisiplinan, manajemen waktu, dan juga ketekunan yang berdampak positif pada fokus belajar dan nilai akademik."
            >
                <x-slot name="icon">
                    <svg class="w-6 h-6 text-gray-800" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <!-- 3. Profile Section -->
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 border-t border-[#f2eaea]">
        <div class="flex flex-col lg:flex-row items-center gap-12">
            
            <!-- Left Image Mockup with colorful border -->
            <div class="w-full lg:w-2/5 flex items-center justify-center">
                <div class="relative w-full max-w-sm">
                    <div class="aspect-square w-full rounded-[2rem] overflow-hidden bg-white p-1 border-2 border-[#f2eaea] shadow-xl">
                        <div class="w-full h-full rounded-[1.8rem] overflow-hidden relative">
            ...
            <div class="w-full lg:w-3/5 space-y-6">
                <h2 class="text-3xl font-bold text-[#2A1B60]">
                ...
                <div class="pt-2">
                    <x-ui.button 
                        class="bg-[#FDE047] hover:bg-[#FACC15] text-[#1F2937] px-6 py-2.5 rounded-xl text-xs font-semibold shadow-md transition-all duration-200"
                    >
                        Selengkapnya
                    </x-ui.button>
                </div>
