    ...
    <x-cards.card title="List Admin">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-3 self-end md:self-auto">
                ...
                <x-buttons.button onclick="window.location.href='{{ route('admin.admin.create') }}'" class="bg-[#6366F1] hover:bg-[#4F46E5] text-white text-xs font-semibold py-2.5 px-4 rounded-lg inline-flex items-center gap-1.5 transition-all shadow-sm">
                    <!-- Plus Icon -->
