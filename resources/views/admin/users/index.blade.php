                ...
                <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                    ...
                    <td class="table-body-cell text-center">
                        <div class="flex items-center justify-center gap-2">
                            <!-- Ubah Button (Yellow) -->
                            <x-buttons.button onclick="window.location.href='{{ route('pengguna.admin.edit', $user->id) }}'" variant="edit" class="shadow-xs">
                            ...
                            <!-- Hapus Button (Red) -->
                            @if(auth()->id() !== $user->id)
                                <form action="{{ route('pengguna.admin.destroy', $user->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus admin ini?');" class="inline">
                                    @csrf
                                    @method('DELETE')
