...
@section('content')
    ...
    <x-cards.card title="List Siswa">
        ...
        <!-- Table Component -->
        <x-tables.table :headers="['#', 'NISN', 'Nama Siswa', 'Tanggal Ditambahkan', 'Action']">
            @php
                $siswas = [
                    ['id' => 1, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 2, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 3, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 4, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 5, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 6, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 7, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 8, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 9, 'nisn' => '2120202', 'nama' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                ];
            @endphp
            ...
            @foreach($siswas as $index => $siswa)
                <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                    ...
                    <td class="table-body-cell font-medium text-gray-900">{{ $siswa['nama'] }}</td>
                    <td class="table-body-cell text-gray-500 font-normal">{{ $siswa['created_at'] }}</td>
                    <td class="table-body-cell text-center">
                        <div class="flex items-center justify-center gap-2">
                            <!-- Ubah Button (Yellow) -->
                            <x-buttons.button onclick="window.location.href='{{ route('pengguna.siswa.edit', 1) }}'" variant="edit" class="shadow-xs">
