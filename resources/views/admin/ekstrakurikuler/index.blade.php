    ...
    <x-cards.card title="List Ekstrakurikuler">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <div class="flex items-center gap-3 self-end md:self-auto">
                ...
                <x-buttons.button onclick="window.location.href='{{ route('ekskul.create') }}'" class="bg-[#6366F1] hover:bg-[#4F46E5] text-white text-xs font-semibold py-2.5 px-4 rounded-lg inline-flex items-center gap-1.5 transition-all shadow-sm">
                    <!-- Plus Icon -->
        ...
        <x-tables.table :headers="['#', 'Ekstrakurikuler', 'Nama Pembina', 'Tanggal Dibuat', 'Action']">
            @php
                // Dummy Data matches the provided admin screenshot
                $ekskuls = [
                    ['id' => 1, 'name' => 'pramuka', 'pembina' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 1, 'name' => 'pramuka', 'pembina' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 1, 'name' => 'pramuka', 'pembina' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 1, 'name' => 'pramuka', 'pembina' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
                    ['id' => 1, 'name' => 'pramuka', 'pembina' => 'Ahmad Jihadudin Salim', 'created_at' => 'January 09, 2025 12.35'],
            ...
            @foreach($ekskuls as $index => $ekskul)
                <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                    ...
                    <td class="table-body-cell font-medium text-gray-900">{{ $ekskul['name'] }}</td>
                    <td class="table-body-cell text-gray-700">{{ $ekskul['pembina'] }}</td>
                    <td class="table-body-cell text-gray-500 font-normal">{{ $ekskul['created_at'] }}</td>
                    <td class="table-body-cell text-center">
                        <div class="flex items-center justify-center gap-2">
                            <!-- Ubah Button (Yellow) -->
                            <x-buttons.button onclick="window.location.href='{{ route('ekskul.edit', 1) }}'" variant="edit" class="shadow-xs">
        ...
        <!-- Load More Button at bottom of table (Matches screenshot) -->
