                ...
                <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                    ...
                    <td class="table-body-cell text-center">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            <x-buttons.button onclick="window.location.href='{{ route('ekskul.show', 1) }}'" class="h-[30px] bg-[#6366F1] hover:bg-[#4F46E5] text-white text-xs font-semibold px-3 rounded-md inline-flex items-center gap-1.5 shadow-xs border-0 transition-all whitespace-nowrap">
