...
Route::prefix('ketua')->name('ketua.')->middleware(['auth', 'role:ketua'])->group(function () {
    ...
    Route::get('/absensi/{sesi_id}', [KetuaDashboardController::class, 'absensiShow'])->name('absensi.show');
    Route::put('/absensi/{sesi_id}', [KetuaDashboardController::class, 'absensiUpdate'])->name('absensi.update');
    Route::delete('/absensi/{sesi_id}', [KetuaDashboardController::class, 'absensiDestroy'])->name('absensi.destroy');
});
